...
class CustomerResourceTest {
    ...
    fun `should update a customer and return 200 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("VenioUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("FerreiraUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("venio@email.com"))
    ...
    private fun builderCustomerUpdateDto(
        firstName: String = "VenioUpdate",
        lastName: String = "FerreiraUpdate",
