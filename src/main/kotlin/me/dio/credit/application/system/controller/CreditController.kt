...
class CreditController(
    ...
    @GetMapping
    fun findById(@RequestParam(value = "customerId") customerId: Long): ResponseEntity<List<CreditViewList>> {
        //val creditViewList: List<Credit> = this.creditService.findAllByCustomer(customerId)
        //return ResponseEntity.status(HttpStatus.OK).body(CreditView(creditViewList))
